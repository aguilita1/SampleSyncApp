...
* Checkout Code [``actions/checkout@v6``](https://github.com/marketplace/actions/checkout)
* Validate composer.json and composer.lock  ``run: composer validate --strict``
* Cache Dev Composer dependencies [``actions/cache@v5``](https://github.com/marketplace/actions/cache)
...
* Setup Docker Buildx [``docker/setup-buildx-action@v4``](https://github.com/marketplace/actions/docker-setup-buildx)
* Docker Meta [``docker/metadata-action@v6``](https://github.com/marketplace/actions/docker-metadata-action)
* Login to Docker Hub [``docker/login-action@v4``](https://github.com/marketplace/actions/docker-login)
* Build and Push Docker Image [``docker/build-push-action@v7``](https://github.com/marketplace/actions/build-and-push-docker-images)
